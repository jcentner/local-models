...
## [2026-06-21] bench | qwen3.5:4b on home-automation v0.4 + email-triage v0.3
...
v0.4 grounding redesign flipped the old h5 0/3 "refuse" into 3/3. **ET v0.3: obs@3 0.917
/ pass^3 0.833** (flaky 1/12) — the same inversion (qwen pass^3 0.833 > gemma 0.667),
only hard-fail e7 (escalates without the required clarifying `ask`). Now apples-to-apples
